...
const RegisterExhibitionPage = () => {
  ...
  return (
    <div className="app-shell register-page">
      ...
      <input ref={fileInputRef} type="file" accept="image/*" hidden onChange={onPosterSelected} />
      <button
        type="button"
      ...
      >
        {posterUrl ? (
          ...
          <span className="register-poster__ph">{uploading ? "업로드 중…" : "＋ 포스터 이미지 첨부"}</span>
        )}
      </button>
      ...
      <div className="register-row">
        <div className="register-field">
          ...
          <input id="rx-start" type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} />
        </div>
        <div className="register-field">
      ...
      <div className="register-row">
        ...
        <div className="register-field">
          ...
          <select id="rx-category" value={category} onChange={(e) => setCategory(e.target.value)}>
            <option value="">선택 안 함</option>
      ...
      <button type="button" className="register-submit" onClick={submit} disabled={submitting || uploading}>
